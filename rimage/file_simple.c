...
#define IMX8_DRAM0_BASE		0x596e8000
#define IMX8_DRAM0_SIZE		0x8000
#define IMX8_SDRAM_BASE		0x92400000
#define IMX8_SDRAM_SIZE		0x800000
...
static int is_sdram(struct image *image, Elf32_Shdr *section)
{
	const struct adsp *adsp = image->adsp;
	uint32_t start, end;
	...
	if (start < adsp->sdram_base)
		return 0;
	if (start >= adsp->sdram_base + adsp->sdram_size)
		return 0;
	if (end > adsp->sdram_base + adsp->sdram_size)
		return 0;
	return 1;
}
...
const struct adsp machine_imx8 = {
	.name = "imx8",
	.iram_base = IMX8_IRAM_BASE,
	.iram_size = IMX8_IRAM_SIZE,
	.host_iram_offset = IMX8_IRAM_HOST_OFFSET,
	.dram_base = IMX8_DRAM0_BASE,
	.dram_size = IMX8_DRAM0_SIZE,
	.host_dram_offset = 0,
	.sdram_base = IMX8_SDRAM_BASE,
	.sdram_size = IMX8_SDRAM_SIZE,
	.host_sdram_offset = 0,
