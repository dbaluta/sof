...
#define FSL_SAI_TCSR	0x08 /* SAI Transmit Control */
#define FSL_SAI_TCR1	0x0C /* SAI Transmit Configuration 1 */
#define FSL_SAI_TCR2	0x10 /* SAI Transmit Configuration 2 */
#define FSL_SAI_TCR3	0x14 /* SAI Transmit Configuration 3 */
#define FSL_SAI_TCR4	0x18 /* SAI Transmit Configuration 4 */
#define FSL_SAI_TCR5	0x1C /* SAI Transmit Configuration 5 */
...
#define FSL_SAI_RCSR	0x88 /* SAI Receive Control */
#define FSL_SAI_RCR1	0x8C /* SAI Receive Configuration 1 */
#define FSL_SAI_RCR2	0x90 /* SAI Receive Configuration 2 */
#define FSL_SAI_RCR3	0x94 /* SAI Receive Configuration 3 */
#define FSL_SAI_RCR4	0x98 /* SAI Receive Configuration 4 */
#define FSL_SAI_RCR5	0x9c /* SAI Receive Configuration 5 */
