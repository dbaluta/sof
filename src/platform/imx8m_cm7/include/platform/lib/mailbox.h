...
#define MAILBOX_DSPBOX_BASE 0x80800000
#define MAILBOX_DSPBOX_OFFSET 0

/* inbox */
#define MAILBOX_HOSTBOX_SIZE 0x1000
#define MAILBOX_HOSTBOX_BASE 0x80801000
#define MAILBOX_HOSTBOX_OFFSET (MAILBOX_DSPBOX_OFFSET + MAILBOX_HOSTBOX_SIZE)


/* outbox */
/* stream */
#define MAILBOX_STREAM_SIZE 0x1000
#define MAILBOX_STREAM_BASE 0x80802000
